                ...
                <swiper-slide>
                    <div >
                        <div class="p-3 bg-white border-bottom">
                           <div class="d-flex">
                               <router-link tag="button" to="/" class="bth bth-lg flex-1">
                                   <i class="iconfont icon-menu"></i>
                                   英雄介绍视频
                               </router-link>
                               <router-link tag="button" to="/" class="bth bth-lg flex-1 ml-2">
                                   <i class="iconfont icon-menu"></i>
                                   一图识英雄
                               </router-link>
                           </div>
                            ...
                            <div class="skills bg-white mt-4">
                                <div class="d-flex jc-around">
                                    <img class="icon" @click="currentSkillIndex=i" :class="{active:currentSkillIndex===i}" :src="item.icon" v-for="(item,i) in model.skills" :key="item.name" >
                                </div>
