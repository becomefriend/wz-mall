            ...
            <el-tabs value="basic" type="border-card">
               <el-tab-pane label="基本信息" name="basic">
                ...
                <el-tab-pane label="技能" name="skills">
                  <el-button @click="model.skills.push({})" size="mini"> <i class="el-icon-plus"></i> 添加技能</el-button>
                    <el-row type="flex" style="flex-wrap: wrap">
                        <el-col :md="12" v-for="(item,i) in model.skills" :key="i">
                            ...
                            <el-form-item>
                                <el-button size="mini" type="danger" @click="model.skills.splice(i,1)">
                                        删除
                                </el-button>
                            </el-form-item>
                        </el-col>
                ...
                <el-tab-pane label="关系" name="partners">
                    <el-button @click="model.partners.push({})" size="mini"> <i class="el-icon-plus"></i>最佳搭档</el-button>
                    <el-row type="flex" style="flex-wrap: wrap">
                        <el-col :md="12" v-for="(item,i) in model.partners" :key="i">
                            ...
                            <el-form-item>
                                <el-button size="mini" type="danger" @click="model.partners.splice(i,1)">
                                    删除
                                </el-button>
                            </el-form-item>
                        </el-col>
    ...
    export default {
        ...
        methods:{
            ...
            async fetch(){
                ...
                // 根据res里面的数据data一个个兑换model里面的数据，只替换后台返回的数据，不会全部替换
