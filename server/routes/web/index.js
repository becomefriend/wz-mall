module.exports = app => {
    ...
    router.get('/news/init', async (req, res) => {
        ...
        const newsTitles = ["铠技能异常问题修复，小乔体型优化进展【老亚瑟的答疑时间】", "《乱世王者》喜迎三周年庆 携手佟丽娅开启大唐盛世", "狄某有话说 |  峡谷送温暖？！元芳正在看着你", "周年庆表现道具设计大赛人气Top20作者采访", "周年庆表现道具设计大赛优秀创意采访：带你走进奇幻梦境！"]
    ...
    router.get('/news/list', async (req, res) => {
        ...
        cats.map(cat => {
            cat.newsList.map(news => {
                // 如果分类名称等于热门，显示新闻的分类的0这个名称，否则显示cat的名称
